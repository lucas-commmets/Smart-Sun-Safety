...
/* -----------------------------------------
REMINDERS ENABLED CONFIRMATION
----------------------------------------- */
...
function sendProtectionNotification(uv) {
...
async function checkReminderUV() {
  ...
  try {
    ...
    /*
    Only notify when UV is 3 or higher.
    */
